<template>
  <div
    :class="
      time === 'night'
        ? 'museumIntroduction nightBgc nightColor'
        : 'museumIntroduction morningBgc morningColor'
    "
  >
    <Header></Header>
    <div
      class="museumIntroduction__container animate__animated animate__fadeIn"
    >
      <div class="space">
        <img src="../assets/TT/切图/2x/06j30a@2x.png" alt="" />
        <div class="spaceIntroduction">
          <h1>
            <div>Space</div>
          </h1>
          <div class="buyBtn" @click="buySpace">Purchase</div>
        </div>
      </div>
      <div class="gallery">
        <img src="../assets/TT/切图/2x/ba3oYT@2x.png" alt="" />
        <div class="galleryIntroduction">
          <h1>
            <div>Gallery</div>
          </h1>
          <div class="buyBtn" @click="buyGallery">Purchase</div>
        </div>
      </div>
      <div class="cyberpunk">
        <img src="../assets/TT/切图/2x/hW7E3X@2x.png" alt="" />
        <div class="cyberpunkIntroduction">
          <h1>
            <div>Cyberpunk</div>
          </h1>
          <div class="buyBtn" @click="buyCyberpunk">Purchase</div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    buySpace() {
      window.open(
        "https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/94111535282872533185076367983495775478047768850277227574032472505830374113780",
        "_blank"
      );
    },
    buyGallery() {
      window.open(
        "https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/94111535282872533185076367983495775478047768850277227574032472506929885741544",
        "_blank"
      );
    },
    buyCyberpunk() {
      window.open(
        "https://opensea.io/assets/0x495f947276749ce646f68ac8c248420045cb7b5e/94111535282872533185076367983495775478047768850277227574032472508029397368860",
        "_blank"
      );
    },
    openDiscord() {
...
@import "~@/assets/stylesheet/museumIntroduction.less";
</style>
